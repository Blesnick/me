...
const statsData: Stat[] = [
  { label: "Years Experience", value: 5, icon: "counter-1.png" },
  { label: "Projects Tested", value: 35, icon: "counter-2.png" },
  { label: "Tools Mastered", value: 18, icon: "counter-3.png" },
  { label: "Certifications", value: 3, icon: "counter-4.png" },
];
